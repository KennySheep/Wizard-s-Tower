...
#include "rapidxml.h"
    ...
    public:
        ...
        void parseDotScene(btDynamicsWorld *phyWorld, const Ogre::String &SceneName, const Ogre::String &groupName, Ogre::SceneManager *yourSceneMgr, Ogre::SceneNode *pAttachNode = NULL, const Ogre::String &sPrependNode = "");
